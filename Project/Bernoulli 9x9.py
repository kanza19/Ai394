...
#Now using bernoulli Naive Bayes for accuracy check
Bernoulli = BernoulliNB()
ypred = Bernoulli.fit(sXTrain, yTrain).predict(sXTest)
...
#Now using bernoulli Naive Bayes for checking accuracy
print("BERNOULLINB:")
Bernoulli = BernoulliNB()
y_pred_bnb = Bernoulli.fit(sXTrain, yTrain).predict(sXTest)
accuracy_bnb = metrics.accuracy_score(yTest, y_pred_bnb)
print(" Bernoulli Accuracy: ",accuracy_bnb)
